...
// `forge build` whenever ReceivableVault.sol's interface changes.

export const receivableVaultAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum ReceivableVault.State"
      }
    ],
    "stateMutability": "view"
  },
